...
API on http://localhost:3001. Seeded users: omar / demo1 / demo2 @example.com, password `Test1234!`, $1,000 each.
**All amounts are integer cents** (1000 = $10.00).

    # login
    curl -X POST localhost:3001/login -H 'content-type: application/json' \
      -d '{"email":"omar@example.com","password":"Test1234!"}'
...
---
Built by **Omar Eshatti** · MIT License
